...
if not DEBUG and CORS_ALLOWED_ORIGINS == ['http://localhost:5173', 'http://127.0.0.1:5173']:
    raise ImproperlyConfigured('CORS_ALLOWED_ORIGINS must be set in production (DEBUG=False)')
